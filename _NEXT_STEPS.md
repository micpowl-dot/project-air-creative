# 🗺️ NEXT_STEPS — Project AIR Game Plan

> This is the master plan. Phases are ordered by dependency — foundational assets come first so nothing downstream gets blocked. Internal deadlines are set with buffer before every hard date.
>
> **Update this file** as tasks are claimed, completed, or reprioritized.
> **Asset-level detail** lives in [assets/asset-tracker.md](assets/asset-tracker.md).

---

## Dependency Logic

Before anything can be designed, two assets must exist:
...
## Phase 6 — Premium Swag On-Site
**Window: June 2–6 | Hard deadline: June 6**
