...
> **Pricing status:** Revisions sent to Canary (Lilli) on May 15 — updated quote expected back **Mon May 18.** See [`docs/vendors.md`](vendors.md) for the full list of revisions requested.
> **Review status:** Pricing + item recommendations sent to Maigh on May 15 for review. Final Tier 1 / 2 / 3 selections pending her decisions before Canary order is locked.
...
> **Pricing note:** Qty reduced from 830 → 600. Re-quote requested from Lilli on May 15 (due May 18). Also asked about: mini / pocket-size notebook option (Field Notes style) + printed screen-cleaning cloths as a possible add.

| Brief Item | Canary Option | Unit Price (orig @ 830) | Total (600) — pending re-quote | Notes |
|-----------|--------------|------------------------|-------------------------------|-------|
| Branded notebook | Branded Notebook | $12.00 | $7,350 + $150 setup | **Pocket-size (Field Notes style) requested from Lilli — pending May 18** |
...
| Screen-cleaning cloth (printed) | **REQUESTED — pricing TBC** | TBC | TBC | **Added to consideration set May 15 — Lilli to quote** |
| AI prompt card (laminated) | **NOT IN CANARY** | — | — | Source separately: Moo, Sticker Mule, or local print |
| **Tier 1 Total (notebook + pin + pen + sticker)** | | | **~$13,000 + ~$600 setup (pre-revision)** | Numbers will shift after May 18 quote |
...
## Open Decisions Before May 18 (Updated)

> **Status (May 15):** Pricing + recommendations sent to Maigh. Items below are now pending her review/decision in parallel with the May 18 Canary re-quote.
...
7. **Badges:** 3 designs (exec / ambassador / site lead) vs. 25 bespoke — decision after May 18 cost data lands.

> ~~Lanyard scope~~ — **Resolved: 25 presenters only, ~30 printed. General attendees do not get lanyards.**
...
| **Primary contact** | Lilli (full name / email TBC) |
| **Most recent outreach** | May 15 — Camille → Lilli, revisions + pricing questions sent. Updated quote due Mon May 18. |
